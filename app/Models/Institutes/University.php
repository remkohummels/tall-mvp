...
class University extends Model
{
    ...
    {
        return $this->hasOne(Booth::class, 'campus_id', 'id');
    }

    public function credits()
    {
        return $this->hasOne(FairCredit::class, 'university_id', 'id');
    }

    public function boothGraphics()
    {
        return $this->hasOne(BoothGraphics::class, 'campus_id', 'id');
    }

    public function boothMenus()
    {
        return $this->hasMany(BoothMenu::class, 'campus_id', 'id');
    }

    public function boothMaterials()
    {
        return $this->hasMany(BoothMaterial::class, 'campus_id', 'id');
    }
    ...
    {
        return $this->hasMany(UniversityProgram::class, 'campus_id', 'id');
    }

    public function bookingRepresentatives()
    {
        return $this->hasMany(BookingRepresentative::class, 'campus_id', 'id');
    }

    public function webinarCredentials()
    {
        return $this->hasOne(WebinarCredential::class, 'campus_id', 'id');
    }
