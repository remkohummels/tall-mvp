 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|University[] $invitedUniverities
 * @property-read int|null $invited_univerities_count
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Fair fair()
...
class Fair extends Model
{
    ...
    public function invitedUniverities()
    {
        return $this->belongsToMany(University::class, Invitation::class);
    }

    public function registeredUniversities()
    {
