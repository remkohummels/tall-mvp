...
class InformationTabs extends Component
{
    ...
    {
        if (!in_array($this->tab, ['basic_info', 'location_info', 'student_info', 'user-personal-info', 'user-emails', 'user-phone-number', 'user-password', 'user-devices', 'user-two-step'])) abort(404);
