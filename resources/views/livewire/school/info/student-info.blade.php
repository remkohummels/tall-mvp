                        ...
                        <form class="mt-3" method="post"  wire:submit.prevent="save">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="h-100">
                                        <label for="number_grade12" class="visually-hidden">Number of Grade 12
                                            students</label>
                                ...
                                <div class="col-lg-6 mobile-marg-2">
                                    <div class="h-100">
                                        <select class="h-100 text-start form-control input-field"
                                            ...
                                            <option value=""> Grade 12 Fee</option>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="h-100">
                                        <label for="number_grade11" class="visually-hidden">Number of Grade 11
                                            students</label>
                                        <input type="text" class="form-control input-field"
                                               name="number_grade11" id="number_grade11"  wire:model.lazy="number_grade11"
                                               placeholder="Number of Grade 11 students">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mobile-marg-2">
                                    <div class="h-100">
                                        <select class="h-100 text-start form-control input-field"
                                            ...
                                            <option value=""> Grade 11 Fee</option>
                                            @foreach ($fee_ranges as $fee_range)
                                                <option value="{{ $fee_range }}"
                            ...
                            <div @class(['d-none'=>$curriculum_id !='British'])>
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="h-100">
                                            <label for="grade_13" class="visually-hidden">Number of Grade 13
                                                students</label>
                                            <input type="text" class="form-control input-field"
                                                   name="grade_13" id="grade_13" wire:model.lazy="grade_13"
                                                   placeholder="Number of Grade 13 students">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 mobile-marg-2">
                                        <div class="h-100">
                                            <select class="h-100 text-start form-control input-field"
                                                ...
                                                <option value=""> Grade 13 Fee</option>
                                                @foreach ($fee_ranges as $fee_range)
                                                    <option value="{{ $fee_range }}">
                                                        {{ $fee_range }}</option>
                                                @endforeach
